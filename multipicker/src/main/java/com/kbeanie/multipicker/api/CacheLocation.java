...
public interface CacheLocation {
    /**
     * Save files directly under various folders of the external com.kbeanie.multipicker.storage,
    ...
    /**
     * Save files under your application's files directory on the external com.kbeanie.multipicker.storage
    ...
    /**
     * Save files under your application's cache directory on the external com.kbeanie.multipicker.storage
     * ex: /sdcard/Android/data/your_package/cache/
     * <p/>
     * These files will be ones that get deleted first when the device runs low on com.kbeanie.multipicker.storage.
     * There is no guarantee when these files will be deleted.
     */
    int EXTERNAL_CACHE_DIR = 300;
    /**
     * Save files under your application's internal com.kbeanie.multipicker.storage directory.
     */
